...
import takologo from '../assets/takoyadong.jpg'
...
import form5 from '../assets/form5.png'
        ...
        <div className='text-white max-w-[1200px] mx-auto my-12' id="project1">
          <div className='md:grid md:grid-cols-2 sm:py-16'>
            ...
            <div className="mt-4 md:mt-0 text-left flex flex-col h-full justify-start py-6 md:py-0">
              ...
              <h1 className="text-4xl font-bold mb-4 primary-color">Project 1</h1>
            ...
            <img className="mx-auto rounded-3xl py-8 md:py-0" src={takologo} width={500} height={500}></img>
            ...
            <div className='md:grid md:grid-cols-2 sm:py-16'>
              ...
              <div className="mt-4 md:mt-0 text-left flex flex-col h-full justify-start py-6 md:py-0">
                ...
                <h2 className="text-3xl font-bold mb-4 primary-color">Form/Window 1</h2>
                  <p className="text-base lg:text-lg">
                  This is form no. 1 and this is where the user or admin will log in or click to go to register.
                  </p>
                </div>
              </div>
            ...
            <div className='md:grid md:grid-cols-2 sm:py-16'>
              ...
              <div className="mt-4 md:mt-0 text-left flex flex-col h-full justify-start py-6 md:py-0">
                ...
                <h2 className="text-3xl font-bold mb-4 primary-color">Form/Window 2</h2>
                  <p className="text-base lg:text-lg">
                  This is form no. 2 and this is where the user/admin will register new info/credentials to be inputted in the users database.
                  </p>
                </div>
              </div>
            ...
            <div className='md:grid md:grid-cols-2 sm:py-16'>
              ...
              <div className="mt-4 md:mt-0 text-left flex flex-col h-full justify-start py-6 md:py-0">
                ...
                <h2 className="text-3xl font-bold mb-4 primary-color">Form/Window 3</h2>
                  <p className="text-base lg:text-lg">
                  This is form no. 3 and this is where the admin will be able to view, add, update and delete student records and also subject information.
            ...
            <div className='md:grid md:grid-cols-2 sm:py-16'>
              ...
              <div className="mt-4 md:mt-0 text-left flex flex-col h-full justify-start py-6 md:py-0">
                ...
                <h2 className="text-3xl font-bold mb-4 primary-color">Form/Window 4</h2>
                  <p className="text-base lg:text-lg">
                  This is form no. 4 and this is where the user choose and confirm whether to exit the application or continue using it.
                  </p>
                </div>
              </div>
            ...
            <div className='md:grid md:grid-cols-2 sm:py-16'>
              ...
              <div className="mt-4 md:mt-0 text-left flex flex-col h-full justify-start py-6 md:py-0">
                ...
                <h2 className="text-3xl font-bold mb-4 primary-color">Form/Window 5</h2>
                  <p className="text-base lg:text-lg">
                  This is form no. 5 and this is the last form where the user is confronted with a confirmation whether to delete an item or not to prevent misclicks from deleteing a record.
                  </p>
                </div>
              </div>
        ...
        <div class="py-10 mb-1 overflow-hidden md:pt-0 sm:pt-10 2xl:pt-10 relative bg-black/90 max-w-[1300px] mx-auto rounded-xl">
          <div className='text-white max-w-[1200px] mx-auto my-12' id="project1">
            <div className='md:grid md:grid-cols-2 sm:py-16'>
              ...
              <iframe className="mx-auto rounded-3xl py-8 md:py-0" width="560" height="315" src="https://www.youtube.com/embed/ThK3dLr4aoI?si=vIPzzJJQJWfFGTq8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
